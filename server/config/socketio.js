...
function onConnect(socket) {
  ...
  require('../api/workOrder/workOrder.socket').register(socket);
  require('../api/bid/bid.socket').register(socket);
  require('../api/taskCat/taskCat.socket').register(socket);
  require('../api/productCat/productCat.socket').register(socket);
  ...
  require('../api/tool/tool.socket').register(socket);
